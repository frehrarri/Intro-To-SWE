...
namespace Banking
{
    public class Signup
    {
        ...
        public void RegisterUser()
        {
            ...
            //open start menu
            BankManager bank = new BankManager(RegisteredUsers);
            bank.OpenStartMenu();
        }
        ...
        private bool ValidateEmail(User user)
        {
            ...
            do
            {
                Console.WriteLine("Please enter your email address. Press x to return to the main menu.");
                ...
                if (!String.IsNullOrEmpty(user.Email))
                {
                    ...
                    //email has necessary formatting
